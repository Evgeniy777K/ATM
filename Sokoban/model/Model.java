...
public class Model {
    ...
    private LevelLoader levelLoader =
            new LevelLoader(Paths.get("C:\\JavaRushTasks\\4.JavaCollections\\src\\com\\javarush\\task\\task34\\task3410\\res\\" +
                    "levels.txt"));
    ...
    public boolean checkWallCollision(
            CollisionObject gameObject, Direction direction) {
    ...
    public boolean checkBoxCollisionAndMoveIfAvailable(
            Direction direction) {
        Player player = gameObjects.getPlayer();
        GameObject stoped = null;
        for (GameObject gameObject : getGameObjects().getAll()) {
