...
//    walls.add(new Wall(Model.FIELD_CELL_SIZE / 2 * 10,
//            Model.FIELD_CELL_SIZE / 2 * 6));
//    walls.add(new Wall(Model.FIELD_CELL_SIZE / 2 * 14,
//            Model.FIELD_CELL_SIZE / 2 * 20));
        Set<Box> boxes = new HashSet<>();
//    boxes.add(new Box(Model.FIELD_CELL_SIZE / 2 * 8,
//            Model.FIELD_CELL_SIZE / 2 * 8));
        Set<Home> homes = new HashSet<>();
//    homes.add(new Home(Model.FIELD_CELL_SIZE / 2,
//            Model.FIELD_CELL_SIZE / 2 * 2));
        Player player = null;
